...
[role="_abstract"]
Configure secrets management for {gitops-title} by integrating with the Secrets Store CSI Driver. You can securely store and inject secrets from external providers such as AWS Secrets Manager into your GitOps workflows.
